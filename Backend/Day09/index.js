...
const FoodMenu=[
    ...
    {id:10,food:"Kabab",category:"non-veg",price:400},
    ...
    {id:16,food:"Mashroom",category:"veg",price:700},
]

const AddToCart=[]
//user ka jo vi add to cart karega sare isme ayega
...
// authentication admin here(Middleware)
// app.use("/admin",Auth)
